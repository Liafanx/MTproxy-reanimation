...
- Readme приведен в порядок, добавлен раздел "Советы"
</details>
...
- Если у вас telemt в докере и реаниматор не помог ни как, в меню mtpr уберите IP через настройки (3 -> c (Очистить IP), после пере примените правила в главном меню (цифра 1).
